    ...
    <div class="profile-card" id="profile-card-root">
      ...
      <div id="tab-layout-example" class="tab-panel" style="display:none;">
        <div style="display:flex;flex-direction:column;height:calc(100vh - 160px);min-height:400px;">
          <!-- Toolbar -->
          <div style="flex-shrink:0;display:flex;align-items:center;gap:8px;padding:4px 10px;background:var(--surface);border-bottom:1px solid var(--border);">
            <button id="le-save-btn-vis" onclick="leSaveLayout()" style="background:#16a34a;border:none;border-radius:4px;color:#fff;padding:4px 16px;font-size:12px;cursor:pointer;font-weight:700;">💾 Save</button>
            <button id="le-save-btn" onclick="leSaveLayout()" style="display:none;"></button>
            <div id="le-notes" style="font-size:10px;color:var(--text-muted);"></div>
          </div>
